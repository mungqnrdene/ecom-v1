...
@section('content')
    @php
        ...
        $rememberFromOld = old('remember');
        $shouldRemember = !is_null($rememberFromOld)
            ? filter_var($rememberFromOld, FILTER_VALIDATE_BOOLEAN)
            : filled($rememberedLogin);
    @endphp
    <div class="auth-wrapper">
        <div class="auth-container">
            <div class="auth-header">
                <span class="auth-badge">👋 Welcome back</span>
                <h1 class="auth-title">Нэвтрэх</h1>
                <p class="auth-subtitle">Таны дансанд нэвтэрч, онцлох бүтээгдэхүүнүүдийг үзээрэй.</p>
            </div>
                ...
                <form method="POST" action="{{ route('users.login.submit') }}">
                    ...
                    <div class="auth-form-group">
                        ...
                        <input type="text" name="identifier" id="identifier"
                            class="auth-input @error('identifier') is-invalid @enderror"
                            value="{{ old('identifier', $rememberedLogin) }}"
                            placeholder="Имэйл эсвэл утасны дугаараа оруулна уу" required autocomplete="username">
                        @error('identifier')
                    ...
                    <div class="remember-forgot">
                        ...
                        <a href="{{ route('users.password.request') }}" class="forgot-password">Нууц үг мартсан?</a>
                    </div>
